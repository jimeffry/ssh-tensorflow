...
def get_symble(input_image,**kargs):
    ...
    with tf.variable_scope(net_name) :
        ...
        b2 = Inverted_residual_seq(b1,6,cn[1],cn[2],2,2,seq_name='res2',**kargs)
        b3 = Inverted_residual_seq(b2,6,cn[2],cn[3],2,3,seq_name='res3',**kargs)
        b4 = Inverted_residual_seq(b3,6,cn[3],cn[4],2,4,seq_name='res4',**kargs)
...
if __name__ == '__main__':
    ...
    with graph.as_default():
        ...
        model = get_symble(img,net_name='mobilenet')
        sess = tf.Session()
